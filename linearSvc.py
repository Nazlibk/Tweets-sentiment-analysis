""" This file is the implementation of linerSVC. After fitting the regressor, this file uses pickle library
...
# Serializing our model to a file called linearSVCModel.pkl
pickle.dump(regressor, open("linearSVCModel.pkl","wb"))
